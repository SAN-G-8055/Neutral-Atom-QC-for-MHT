...
Shared deterministic detections (six-frame window: recall $0.64$, precision
$0.86$, centroid F1 $0.73$ at 10 px); human tracking ground truth grades the
detector only. Six MWIS instances of 9--12 tracks.
