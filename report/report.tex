...
shared deterministic detector (six-frame window: recall $0.64$, precision
$0.86$, centroid F1 $0.73$ at a fixed $10$ px gate); the human tracking ground
truth grades the detector only. From
